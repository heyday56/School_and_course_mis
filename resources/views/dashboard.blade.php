<x-app-layout>
    <div class="container h-screen flex flex-row justify-between items-center  rounded-lg rounded-br-lg">
        <div class="sidebare bg-white pt-5 w-1/5 h-full">
        ...
        <div class="article bg-gray-950 w-2/3 max-h-fit">article</div>
    </div>
    <script>
